...
def main():
    # initialize modelB4 with parsT =  1.75491293   0.80264804   0.11403616   0.11108245   0.01499881   0.83527654   0.30026903   0.30599743 
    p50 = ModelB4([1.75491293, 0.80264804, 0.11403616, 0.11108245, 0.01499881, 0.83527654, 0.30026903, 0.30599743])
    p50.calculateState(0, 0.25)
    p50.calculateF()
    print(p50.f)
    # Load the dictionary 'p50_dict.npy' and add the following key-value pairs: 'B4': p50.f
