...
def change_equations(t, states, pars, inputs):
	...
	# Unpack pars
	p_act_ifnar_ifnb = pars['p_act_ifnar_ifnb']
	...
	difnar_in = psyn_ifnar_in-pdec_ifnar_in*ifnar_in-p_act_ifnar_in*ifnar_in-(p_act_ifnar_ifnb*ifnar_in**p_coop_ifnar*ifnb*np.exp(-t/p_tau_ifnb))+p_deact_ifnar * ifnar
	difnar = psyn_ifnar-pdec_ifnar*ifnar+p_act_ifnar_in*ifnar_in+(p_act_ifnar_ifnb*ifnar_in**p_coop_ifnar*ifnb*np.exp(-t/p_tau_ifnb))-p_deact_ifnar * ifnar
