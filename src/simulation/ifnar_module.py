...
# 
def change_equations(states, pars, inputs):
	...
	difnar_in = psyn_ifnar_in-pdec_ifnar_in*ifnar_in-p_act_ifnar_in*ifnar_in-p_ifnb*ifnb+p_deact_ifnar * ifnar
	difnar = psyn_ifnar-pdec_ifnar*ifnar+p_act_ifnar_in*ifnar_in-p_ifnb*ifnb-p_deact_ifnar * ifnar
