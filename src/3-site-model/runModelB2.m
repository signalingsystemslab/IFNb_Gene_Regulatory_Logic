...
save('../data/bestFit_3site_b2.mat','parsFinal','rss','resid','rmsd','seed', ...
    "aic")
...
save('../data/bestFit_3site_b2_syndata.mat','parsSyn','rss_syn','rmsd_syn',"aic_syn","resid_syn")
%% Investigate synthetic data
fprintf("Saving syn data minimums\n")

load('../data/bestFit_3site_b2_syndata.mat')
...
save('../data/pars_3site_b2_syndata_small.mat','min_rmsd_syn','params_best_syn',"res_best_syn")
...
writematrix(params,'../data/ModelB2_parameters.csv')
writematrix(rmsd,'../data/ModelB2_rmsd.csv')
writematrix(aic,'../data/ModelB2_aic.csv')
writematrix(res,'../data/ModelB2_res.csv')
%% Functions
% In matlab local functions go at the end for some reason
function r=obj(p, exp_matrix)
    [~,~,r]=objfuncB2(p,exp_matrix,1,1);
end
