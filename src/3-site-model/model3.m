...
classdef model3
    ...
    properties
        ...
        beta=zeros(8,1);
        parsC=zeros(2,1); % 5 C parameters (cooperativity)
    ...
    methods
        ...
        function obj = model3(pars) % pars length should be 11
            ...
            if(nargin > 0)
                obj.parsC = pars(1:2);
                obj.parsT = pars(3:end);
                obj.beta = [1 1 obj.parsC(1) 1 ...
                    obj.parsC(2)*obj.parsC(1) 1 obj.parsC(1) obj.parsC(1)*obj.parsC(2)]'; %'I1I2','I1N','I2N','I1I2N'
                obj.t = [0 obj.parsT 1]'; 
            end
        end
