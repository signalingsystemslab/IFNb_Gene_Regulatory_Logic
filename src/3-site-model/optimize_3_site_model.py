# Using 3-site model data, grid search for global minimum RMSD and locally minimize using least squares
...
def optimize_model_local(N, I, beta, model_name, pars):
    ...
    if t < 60:
        ...
        print("Time elapsed: %d minutes %.2f seconds" % (t/60, t%60))
    else:
        print("Time elapsed: %d hours %.2f minutes" % (t/3600, (t%3600)/60))
...
pars, rho, residuals = optimize_model_local(training_data["NFkB"], training_data["IRF"], training_data["IFNb"], 
                                            "B1", b1_starting_pars)
