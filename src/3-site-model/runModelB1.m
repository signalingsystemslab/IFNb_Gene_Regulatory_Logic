...
fprintf("Starting experimental data\n")
seed = 5;
...
% t0=0, t1-t6 are optimized between 0 and 1, t7=1
...
save('../data/bestFit_3site_b1.mat','parsFinal','rss','resid','rmsd','seed', ...
    "aic")
...
save('../data/bestFit_3site_b1_syndata.mat','parsSyn','rss_syn','rmsd_syn',"aic_syn","resid_syn")
%% Investigate synthetic data
fprintf("Saving syn data minimums\n")

load('../data/bestFit_3site_b1_syndata.mat')
...
save('../data/pars_3site_b1_syndata_small.mat','min_rmsd_syn','params_best_syn',"res_best_syn")
...
writematrix(params,'../data/ModelB1_parameters.csv')
writematrix(rmsd,'../data/ModelB1_rmsd.csv')
writematrix(aic,'../data/ModelB1_aic.csv')
writematrix(res,'../data/ModelB1_res.csv')
%% Functions
% In matlab local functions go at the end for some reason
function r=obj(p, exp_matrix)
    [~,~,r]=objfuncB1(p,exp_matrix,1,1);
end
